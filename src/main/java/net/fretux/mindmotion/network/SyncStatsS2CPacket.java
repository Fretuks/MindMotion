...
public class SyncStatsS2CPacket {
    ...
    public SyncStatsS2CPacket(float sanity, float insanity, int tempo, int ventCooldown) {
        this.sanity = sanity;
    ...
    public static SyncStatsS2CPacket decode(FriendlyByteBuf buf) {
        return new SyncStatsS2CPacket(buf.readFloat(), buf.readFloat(), buf.readInt(), buf.readInt());
    }
